 ...
 * direction respects the coefficient of restitution (COR), while the wall tangential direction is
 * tuned with a friction factor (a function of COR) to prevent the "wall-riding" phenomenon.
